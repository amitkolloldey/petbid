...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <?php
        $query = "SELECT * FROM pet_categories WHERE id='$id'";
        ...
        <form class="form-horizontal" method="POST" action="">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                <input id="title" name="name" placeholder="Enter Category Name" class="form-control input-md" type="text" value="<?php echo $row['name']; ?>">
...
$query = "UPDATE pet_categories SET name = '$name' WHERE id = '$id'";
