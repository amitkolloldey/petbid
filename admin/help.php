  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-12">
          <?php
              $query = "SELECT title, content FROM pages WHERE id='3'";
          ...
          $query = "INSERT INTO pages(id , title , content) VALUES('3' , '$title' , '$content')";
          ...
          */
          ...
          if($utitle == '' || $ucontent == '' ){
            ...
            $query = "UPDATE pages SET title='$utitle',content='$ucontent' WHERE id='3'";
