  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-12">
          <?php
              $query = "SELECT title, content FROM pages WHERE id='2'";
          ...
          $query = "INSERT INTO pages(id , title , content) VALUES('2' , '$title' , '$content')";
          ...
          */
          ...
          if($utitle == '' || $ucontent == '' ){
            ...
            $query = "UPDATE pages SET title='$utitle',content='$ucontent' WHERE id='2'";
